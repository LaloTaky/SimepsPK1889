 ...
 <link href="<%:Page.ResolveUrl("~/Content/carouselIndSectorial.css")%>" rel="stylesheet" />
   ...
   <div class="row col-xs-12 ddlFloat" style="margin-top: 2%;">
      <div class="col-md-9">
         ...
         <asp:ObjectDataSource ID="odsSectores" runat="server" TypeName="SIMEPS.Dal.IndicadoresDal" SelectMethod="ConsultarSectores">
            <SelectParameters>
   ...
   <div class="row col-md-12">
      ...
      <div class="col-md-12">
         ...
         <asp:ObjectDataSource ID="odsDetalleSector" runat="server" TypeName="SIMEPS.Dal.IndicadoresDal" SelectMethod="ConsultaEstadisticaBasica">
            <SelectParameters>
   ...
   <div class="row">
      <div class="col-xs-12">
        <div class="contenCarousel">
            ...
            <asp:ObjectDataSource ID="odsProgramas" runat="server" TypeName="SIMEPS.Dal.IndicadoresDal" SelectMethod="ConsultarProgramaSectoriales">
               <SelectParameters>
   ...
   <br />
   <div  ID="divIndicadorPro" runat="server">
     <div>
            ...
            <div class="col-xs-12">
               <div class="col-xs-6">
                  <div class="contenCounter">
                     ...
                     <label class="lbcontador-objetivos">Objetivos</label>
                  </div>
               </div>
               <div class="col-xs-6">
                  <div class="contenCounter">
                     <div class="lblIndicadoresS">
                        <asp:Label runat="server" ID="lbIndicadoresSecL" class="lbIndicadoresSecL"></asp:Label>
                     </div>
                     <label class="lbcontador-indicadores">Indicadores</label>
                  </div>
               </div>
            </div>
                  ...
                  <div class="panel panel-default">
                     ...
                     <div id="collapseTwo" class="panel-collapse collapse">
                        <div class="panel-body-white">
                                 ...
                                 <div class="panel-group" id="accordion2">
                                    <div class="panel panel-default">
                                       ...
                                       <div id="<%#Eval("NUM_OBJETIVO")%>" class="panel-collapse collapse">
                                          ...
                                          <asp:ObjectDataSource ID="odsIndicadores" runat="server" TypeName="SIMEPS.Dal.IndicadoresDal" SelectMethod="ConsultarIndicadoresSectoriales">
                                             <SelectParameters>
                           ...
                           <asp:ObjectDataSource ID="odsObjetivosSecL" runat="server" TypeName="SIMEPS.Dal.IndicadoresDal" SelectMethod="ConsultarObjetivosSectoriales">
                              <SelectParameters>
               ...
               <div class="row">
                  <asp:Repeater ID="DetalleIndicador" runat="server" DataSourceID="odsDetalleIndicador" OnItemDataBound="DetalleIndicador_ItemDataBound">
                     <ItemTemplate>
                        ...
                        <div class="col-md-6">
                           <br>
                           <asp:Label ID="LblNotaEdu" runat="server" Text='<%# Eval("CAMBIO_TEXTO") %>' Visible="false" />
                        ...
                        <div class="grafDetInd col-lg-6">
                           <div class="row">
                              <div id="divGrafIndicadorSectorial" style="width: 100%; height: 400px; margin: 5px -6px 20px;"></div>
                              <div id="DivLPU" runat="server">
                                 <div class="col-md-12">
                                    <p style="font-size: 11px">*La información publicada fue verificada por las dependencias y entidades responsables de los programas.</p>
                                     <asp:Label ID="lblNotaIndicador" runat="server" Text="Label"></asp:Label>
                                 </div>
                              </div>
                           </div>
                        </div>
                              ...
                              <center>
                                 <div class="col-md-12 " >
                                    ...
                                    <div class="col-md-3 " >
                                       ...
                                       <div>
                                             <label style="text-align:center">Meta 2018</label>
                                       </div>
                                    </div>
                                    <div class="col-md-3 " >
                                       ...
                                       <div>
                                             <label style="text-align:center">Porcentaje de avance con respecto al 2018</label>
                                       </div>
                                    </div>
                                 </div>
                              </center>
                  ...
                  <asp:ObjectDataSource ID="odsDetalleIndicador" runat="server" TypeName="SIMEPS.Dal.IndicadoresDal" SelectMethod="ConsultarDetalleIndicador">
                     <SelectParameters>
