<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="IndicadorSectorial19-24.aspx.cs" Inherits="SIMEPS.IndicadorSectorial19_24" %>
   ...
   <div id="idGralDetalleInd"   class="row equal" runat="server">
      <div id="idDivListObj" class="col-md-4 indSecBackGrounds">
         <div class="row">
             ...
             <div class="col-xs-12">
               <div class="col-xs-4">
                  <div class="contenCounter" style="width:98px">
                              ...
                              <ItemTemplate>
                                 ...
                                 <div class="panel-group" id="accordion2">
                                    <div class="panel panel-default">
                                       ...
                                       <div id="<%#Eval("NUM_OBJETIVO")%>" class="panel-collapse collapse" onclick="MantenerAcordeon(<%#Eval("NUM_OBJETIVO")%>)">
      ...
      <div id="IndicadoresdeFin" class="col-md-8 detIndSecBackGrounds">
         ...
         <div class="row">
            <div class="col-xs-12" onload="Page_Load">
               ...
               <div id="divBotones" class="row" style="display:none">
                  <div class="row col-md-6">
                     <div class="col-md-3 ">
                        <asp:Image ImageUrl="img/descarga_datos3.jpg" runat="server" ID="imgbFTIndicadores" Width="55px" CssClass="btnDescargas" />
                     </div>
                     <div class="col-md-3 ">
                        <label id="idlblfichaTecPlur" class="imgBtnDescargaRep">Fichas técnicas de los indicadores</label>
                     </div>
                     <div class="col-md-3 ">
                        <asp:Image ImageUrl="img/descarga_docdatos.jpg" runat="server" ID="imgbFTIndicadorSec" Width="55px" CssClass="btnDescargas"/>
                     </div>
                     <div class="col-md-3 ">
                  ...
                  <div class="row col-md-6">
                     <div class="col-md-3 ">
                        <asp:Image ImageUrl="img/descarga_excel.jpg" runat="server" CssClass="imgbBDExcel" ID="ImageButton2" Width="55px"/>
                     </div>
                     <div class="col-md-3 ">
                        <label class="imgBtnDescargaRep">Base de datos de excel</label>
                     </div>
                     <div class="col-md-3 ">
                        <asp:Image ImageUrl="img/descarga_csv.jpg" CssClass="btnDescargas" runat="server" Width="55px"  />
                     </div>
                     <div class="col-md-3 ">
               ...
               <div class="row">
                     ...
                     <ItemTemplate>
                        <div class="row">
                           <div class="col-xs-12">
                              <%-- <label class="headerdetalleIndicador">Nombre del Indicador: <%#Eval("NOMBRE")%></label>--%>
                               <strong id="NIndicador" hidden="hidden" runat="server"><%#Eval("NOMBRE") %></strong>
                              <br />
                              <br />
                         ...
                         <div class="grafDetInd col-lg-10">
                           <div class="row">
                              ...
                              <div id="DivLPU" runat="server">
                                 <div class="col-md-10">
                                    <p style="font-size: 11px"><%#Eval("DOF_LB_DESCRIPCION")%></p>
                                    <p style="font-size: 11px"><%#Eval("DOF_META_DESCRIPCION")%></p>
                        ...
                        <div class="col-md-10">
                           ...
                           <p style="color: dimgray" class="borderParrafo1">Objetivo Prioritario: <span class="textoIndicadores"><%#Eval("OBJETIVO")%></span></p>
                            ...
                            <p style="color: blue; -ms-word-wrap: break-word;" class="borderParrafo4">Enfoque de Resultados del objetivo: <span class="textoIndicadores"><%#Eval("ENFOQUE_RES")%></span></p>

                           <p style="color: deepskyblue" class="borderParrafo2">Definición: <span class="textoIndicadores"><%#Eval("DESCRIPCION")%></span></p>

                           

                           <p style="color: dodgerblue" class="borderParrafo4">Método de cálculo: <span class="textoIndicadores"><%#Eval("METODO")%></span></p>

                           <p style="color: blue; -ms-word-wrap: break-word;" class="borderParrafo5">Medio de verificación: <span class="textoIndicadores"><%#Eval("FUENTE")%></span></p>
                            
                           <p style="color: blue; -ms-word-wrap: break-word;" class="borderParrafo4">Enfoque de Resultados del Indicador: <span class="textoIndicadores"><%#Eval("ENFOQUE_INDICADOR")%></span></p>
                            ...
                            <p style="color: dodgerblue" class="borderParrafo4">Nivel de desagregación: <span class="textoIndicadores"><%#Eval("NIVEL_DESAGREGACION")%></span></p>
                                <p style="color: dodgerblue" class="borderParrafo4">Acumulado o periódico:  <span class="textoIndicadores"><%#Eval("ACUM_PER")%></span></p>
                           ...
                           <div class="col-md-12">
                              ...
                              <center>
                                 <div class="col-md-12 " >
                                    ...
                                    <div class="col-md-3 " >
                                       <div class="counterDesempenoInd" style="background-color: <%#Eval("META_COLOR")%>"><%#Eval("METATEXT")%></div>
                                       <div>
                           ...
                           <div class="row col-md-6">
                              ...
                              <p style="font-size: 20px; font-weight: bold; text-align: justify">Calidad del indicador</p>
                               <div class="imgCalidad">
                                 <asp:Image runat="server" ImageUrl='<%# (bool)Eval("ADECUACION") ? "img/iconoindicador_02.jpg":"img/iconoindicador_01.jpg"%>' />
                  ...
                  <asp:ObjectDataSource ID="odsDerechosInd" runat="server" TypeName="SIMEPS.Dal.IndicadoresDal" SelectMethod="ConsultaDerechoSocialInd4T">
                     <SelectParameters>
                        <asp:Parameter Name="idIndicador" DefaultValue="-1" />
                     </SelectParameters>
                  </asp:ObjectDataSource>
...
<script> 
    $(document).ready(function () {
        ...
        if (last != null && last != "") {
            ...
            $("#" + last).collapse("show");
            $('#ContentPlaceHolder1_hfAccordionIndex').val("");
        }

    });
    function MantenerAcordeon(id) {
        $('#<%= hfAccordionIndex.ClientID %>').val(id);
    }
</script>
</asp:Content>
