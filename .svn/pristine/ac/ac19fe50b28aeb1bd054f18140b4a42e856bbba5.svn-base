...
namespace SIMEPS
{
    public partial class DescargarFTIndicador : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
...

            {
                ...
                Modelo.IndicadorSectorial detalleIndicador = indicadores.ConsultarDetalleIndicador(idIndicador, 1).FirstOrDefault();
                List<Modelo.Meta> datosGrafica = indicadores.ConsultarMetasIndicador(idIndicador, 2);
                ...
                {
                    nombreArchivo = tipoReporte.NOMBRE_ARCHIVO + "_" + sector + "_" + programaSec.Substring(0, 34) + "_" + idIndicador + "." + tipoReporte.FORMATO;
                }
                else
                {
                    nombreArchivo = tipoReporte.NOMBRE_ARCHIVO + "_" + sector + "_" + programaSec + "_" + idIndicador + "." + tipoReporte.FORMATO;
                }
                ...
                {
                    existeTR = nuevoReporte.buscarTR(nombreArchivo, tipoReporte.ID_TIPO_REPORTE, null, null, null, null, idIndicador, null, null);
                }
                ...
                else if (archivoRecuperado == null && !existeTR)
                {
                    ...
                    ws.Name = "Ficha Tecnica del Indicador";
                    ...
                    var resultado = nuevoReporte.guardarDocumento(rutaArchivo, nombreArchivo, filename, tipoReporte.ID_TIPO_REPORTE, null, null, null, null, idIndicador, null, null);
        ...
        public void ProgramasAliados(Worksheet ws, int idIndicador)
        {
            iFila++;
            int filaInicio = iFila;
            string letter = comun.columnLetter(columnaFinal);
            ...
            List<SIMEPS.Modelo.ProgramaIndicadorMIR> programas = indicadores.ConcultarProgramaIndicador(idIndicador);
