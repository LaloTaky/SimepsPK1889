<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DetalleIndicadorFin.aspx.cs" Inherits="SIMEPS.DetalleIndicadorFin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="main">
        ...
        <div id="divSubHead" runat="server" style="margin: 10px">
            <div class="row">
                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                    <div class="headerProgramaFin TituloFin margenDetInd" style="line-height:50px;">
                        <label>Indicadores de Fin de los programas y acciones sociales, <%=Request.Params["pCiclo"].ToString()%></label>
                    </div>
                    <div class="headerProgramaFin TituloDependenciaFin">
                        <asp:Label ID="LblDependencia" runat="server" Text="Dependencia" style="margin:50px 0;"></asp:Label>
                    </div>
                    <div class="headerProgramaFin TituloProgramaFin margenDetInd" style="line-height:50px;">
                        <asp:Label ID="LblTituloPrograma" runat="server" Text="Programa seleccionado"></asp:Label>
                    </div>
                   <div class="headerIndicadorFin">
                        <asp:Label ID="LblTituloObjetivo" runat="server" Text="Objetivo"></asp:Label><br />
                    </div>
                    <div class="headerIndicadorFin margenDetInd" style="margin-left: 70px; margin-top:15px;">
                        <asp:Label ID="LblTituloInd" runat="server" Text="Indicador seleccionado"></asp:Label>
                    </div>
                    ...
                    <tr>
                        <td>
                            <table class="tablaDetalleInd">
                                <asp:Label ID="lblNombreInd" runat="server" Text='<%#Eval("NOMBRE_IND") %>' style="display: none;"></asp:Label>
                                <tr>
                                    <td class="indicadorDetalleTd columnDetalleInd" style="background-color: #C7DCE2; border: 2px; border-color: #FFFFFF; border-style: solid;">Objetivo
                                    </td>
                                    <td class="indicadorDetalleTd" style="background-color: #F0EDEE; border: 2px; border-color: #FFFFFF; border-style: solid;">
                                        <asp:Label ID="Lbl1TituloObjetivo" runat="server" Text='<%#Eval("DESC_NIVEL")%>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="indicadorDetalleTd" style="background-color: #C7DCE2; border: 2px; border-color: #FFFFFF; border-style: solid;">
                                        <asp:Label ID="lblDefInd" CssClass="IndicadorIzquierda" runat="server" Text='<%#Eval("DEFINICION_IND") %>'></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                   ...
                                   <div class="row">
                                    <h5 class="" style="color: #000000; font-weight: bold; font-size: 17px;">Estadísticas rápidas</h5>
                                        ...
                                        <div class="row col-md-12 metasAll">
                                            <asp:Label style="color: #000000; font-weight: bold; font-size: 15px;" Text="Metas Planeadas" runat="server"/>
                                        </div>
                                       <br />
                                       <br />
                                        <div class="row">
                                       ...
                                       <br />
                                        <div class="row col-md-12">
                                            <asp:Label style="color: #000000; font-weight: bold; font-size: 15px;" Text="Metas Alcanzadas" runat="server" />
                                        </div>
                                       <br />
                                       <br />
                                        <div class="row">
