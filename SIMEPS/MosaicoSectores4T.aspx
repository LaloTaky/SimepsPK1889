<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MosaicoSectores4T.aspx.cs" Inherits="SIMEPS.MosaicoSectores4T" %>
      ...
      <div class="col-xs-12">
          <div class="col-md-3 col-md-offset-9 col-sm-4 col-sm-offset-8 col-xs-12" style="float:right; zoom:0.8; margin-top:-26px; padding:10px; right:0px;" id="divBotonDescargaBD">
                <div class="col-md-4 col-xs-2 col-sm-4">
                   <asp:ImageButton ImageUrl="img/descarga_datos2.jpg" runat="server" ID="ImgBtnDescargaBD" Width="55px" CssClass="btnDescargas"/>
                </div>
         ...
         <div class="jumbotron">
            <div class="row" style="width: 100%">
               <asp:Repeater ID="rprContador" runat="server" DataSourceID="odsContadorSipol">
                  <ItemTemplate>
                     <div class="col-xs-6 col-md-2 margencounter">
         ...
         <asp:Repeater ID="rprMosaicos" runat="server" DataSourceID="odsMosaicos">
            <ItemTemplate>
               <div class="col-xs-6 col-md-3 response">
                  <a href="IndicadorSectorial4T.aspx?idsector=<%#Eval("ID_SECTOR")%>">
