...
namespace SIMEPS
{
    public partial class IndicadorSectorial : System.Web.UI.Page
    {
        ...
        {
            Modelo.ContadorIndObj contador = new Modelo.ContadorIndObj();
            contador = indicadorDAL.contadorIndicadoresObjetivos(idProgramaSectorial);
            if (contador != null)
            {
                lbIndicadoresSecL.Text = contador.COUNT_IND.ToString();
        ...
        protected void DetalleIndicador_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                System.Web.UI.WebControls.Label NotaIndicador = (System.Web.UI.WebControls.Label)e.Item.FindControl("lblNotaIndicador");
                NotaIndicador.CssClass = "lblNota-Indicador";
                NotaIndicador.Text=notaIndicador;
